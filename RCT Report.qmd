...
[^1]: The replication code is available on [GitHub](https://github.com/boltikpravyi/rct_hw) and [Google Colab](https://colab.research.google.com/github/boltikpravyi/rct_hw/blob/main/RCT_Interactive_Notebook.ipynb). Additional materials (figures and tables) can be found in the Appendix A of this note.
